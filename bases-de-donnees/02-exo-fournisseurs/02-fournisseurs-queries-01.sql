...
/* 4. Sélectionner le nom des produits, leur prix, 
et le nom du fournisseur associé */
...
/* 5. Sélectionner le nom des produits, leur prix, 
et le nom du fournisseur pour chaque produit 
dont le prix est supérieur à la moyenne des prix des produits */
...
SELECT codeEmpl, employe.nomR, nom, COUNT(codeA) 
FROM employe 
...
Pour chaque article, indiquer le nom du ou des fournisseurs, 
