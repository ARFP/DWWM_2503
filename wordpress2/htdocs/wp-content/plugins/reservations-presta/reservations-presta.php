...
add_action('init', 'mde_cpt_prestation');
...
function mde_afficher_details($post) {
...
function mde_afficher_boite_formulaire() {
...
function mde_sauvegarder_details($post_id) {
...
add_action('save_post', 'mde_sauvegarder_details');




function mde_afficher_details_front($content) {
...
/*
function mde_afficher_details_front2($content) {
