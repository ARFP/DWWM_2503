...
/**
 * Class Blogdata_Customizer_Range_Control
 *
 * @access public
 */
class Blogdata_Customizer_Range_Control extends WP_Customize_Control {
 ...
 * @param  string $string Input.
 */
function blogdata_is_json( $string ) {
	return is_string( $string ) && is_array( json_decode( $string, true ) ) ? true : false;
}
